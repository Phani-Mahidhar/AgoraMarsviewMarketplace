...
namespace agora {
    namespace extension {
        ...
        jobject JniHelper::getGlobalContext(JNIEnv **env) {
            jclass activityThread = (*env)->FindClass("androidx/appcompat/app/AppCompatActivity");
            jmethodID currentActivityThread = (*env)->GetStaticMethodID(activityThread, "a", "()Landroid/app/ActivityThread;");
